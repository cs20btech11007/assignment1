...
\begin{align}
 \pr{X=0}&=\comb{2}{0} \times \brak{\frac{1}{4}}^{0} \times  \brak{\frac{3}{4}} ^{2-0}=\frac{9}{16}=0.5625\nonnumber\\
\pr{X=1}&=\comb{2}{1} \times \brak{\frac{1}{4}}^{1} \times  \brak{\frac{3}{4}} ^{2-1}=\frac{6}{16}=0.375\nonnmuber\\
 \pr{X=2}&=\comb{2}{2} \times \brak{\frac{1}{4}}^{2} \times  \brak{\frac{3}{4}} ^{2-2}=\frac{1}{16}=0.0625\nonmumber\\
 \end{align}
\end{document}
