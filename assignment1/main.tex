...
\begin{equation}
P(X=k)_t={n \choose k}( \frac{1}{4})^{n} (1-\frac{1}{4}) ^{n-k}
\end{equation}\\

$P(X=0)_t $ denotes the " 0 " number of times the coins showed tail in 2 tosses.\\

$$ P(X=0)_t={2 \choose 0}( \frac{1}{4})^{0} (1-\frac{1}{4}) ^{2}=\left(\frac{3.3}{4.4}\right)=\frac{9}{16}$$\\
\\$P(X=1)_t $ denotes the " 1 " number of times the coins showed tail in 2 tosses.\\
$$p(X=1)_t={2 \choose 1}(\frac{1}{4} )^{1} ((1-\frac{1}{4}) ^{1}=(2)\left(\frac{1.3}{4.4}\right)}}=\frac{6}{16}$$\\
\\$P(X=2)_t $ denotes the " 2 " number of times the coins showed tail in 2 tosses.\\
$$p(X=2)_t={2 \choose 2}( \frac{1}{4})^{2} (1-\frac{1}{4}) ^{0}=\left(\frac{1.1}{4.4}\right)=\frac{1}{16}$$\\
